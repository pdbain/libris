...
public class DatabaseRecordWindow extends RecordWindow<DatabaseRecord> {
	...
	public DatabaseRecordWindow(LibrisWindowedUi ui, LibrisLayout layout, DatabaseRecord rec, boolean editable, 
			ActionListener modificationListener) throws LibrisException {
		this(ui, layout, rec, new Point(0, 0), editable, modificationListener);
	}

	public DatabaseRecordWindow(LibrisWindowedUi ui, LibrisLayout layout, DatabaseRecord rec, Point position, boolean editable, 
			ActionListener modificationListener) throws LibrisException {
		super(ui, layout, rec, position, editable, modificationListener);
		this.record = rec;
	}

	public DatabaseRecordWindow(LibrisWindowedUi ui, LibrisLayout myGuiLayout, DatabaseRecord rec, Point point, 
			ActionListener modificationListener) throws LibrisException {
		this(ui, myGuiLayout,  rec,  point, false, modificationListener);
	}
	
	protected void layOutWindow(LibrisWindowedUi ui, LibrisLayout layout, DatabaseRecord rec) throws LibrisException {
